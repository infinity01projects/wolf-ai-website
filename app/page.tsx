...
export default function HomePage() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-900 to-gray-800 text-white">
      ...
      <section id="features" className="bg-gray-800 py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gray-700 p-8 rounded-xl hover:shadow-lg transition-shadow">
      ...
      {/* Download Section */}
      <section id="download" className="py-16 bg-gradient-to-b from-gray-800 to-gray-900">
        <div className="container mx-auto px-6 text-center">
          ...
          <button className="bg-purple-600 hover:bg-purple-700 text-white font-bold py-4 px-8 rounded-lg transition-colors inline-flex items-center">
      ...
      <div id="mobile-menu" className="fixed inset-0 bg-gray-900 bg-opacity-95 z-50 hidden">
        <div className="flex justify-end p-6">
          <button id="close-menu" className="focus:outline-none">
            <svg
              className="w-6 h-6"
              fill="none"
              stroke="currentColor"
